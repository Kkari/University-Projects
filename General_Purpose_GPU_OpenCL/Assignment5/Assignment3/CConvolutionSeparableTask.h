...
protected:
	...
	cl_program      m_SobelProgram = nullptr;
	cl_program		m_NonMaxProgram = nullptr;
	cl_program      m_HystProgram = nullptr;
    ...
    cl_kernel       m_SobelKernel = nullptr;
    cl_kernel       m_NonMaxKernel = nullptr;
    cl_kernel       m_HystKernel = nullptr;
    cl_kernel       m_HystKernelComp = nullptr;
};
