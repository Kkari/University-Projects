...
struct ImageTextureWrapReference
{
...
#define TEXTURE_WRAP_CLASS ImageTextureWrapReference
...
{
	return ImageTextureWrapReference::wrap_clamp(val, size);
}

int ImageTexture::
wrap_repeat(int val, int size)
{
	return ImageTextureWrapReference::wrap_repeat(val, size);
}
