...
static TwEnumVal scene_enum[] = {
	...
	{ RaytracingParameters::TRIANGLES,         "Triangles"       },
};
...
derived_gui_setup(TwBar* bar)
{
	...
	TwAddVarRW(bar, "filtered_envmap", TW_TYPE_BOOLCPP, &filtered_envmap, "label='Use Filtered Envmap' group='Shading Settings'");
	TwAddVarRW(bar, "num_triangles",   TW_TYPE_INT32,   &num_triangles,   "label='Number of Triangles' group='Shading Settings' min=1");
