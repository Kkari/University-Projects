...
public class UDFEuclideanDistance extends GenericUDF {
	...
	public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
	    ...
	    if (arguments.length != 2) {
	        throw new UDFArgumentLengthException("euclideanDistance() expects 2 arguments: Array<Float>, Array<Float>");
	    }
	    
	    // check if arguments are arrays
	    if(!(arguments[0] instanceof ListObjectInspector) || !(arguments[1] instanceof ListObjectInspector)) {
	    	throw new UDFArgumentException("euclideanDistance() expects 2 arguments: Array<Float>, Array<Float>");
	    }
	...
	public Object evaluate(DeferredObject[] arguments) throws HiveException {
		...
		if(v1.size() != v2.size()) {
			throw new HiveException("euclideanDistance(): both vectors must have equal size");
		}
		
		return VectorMetrics.euclideanDistance(v1, v2);
	}
